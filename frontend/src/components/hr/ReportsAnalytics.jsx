  ...
  return (
    <div className="p-6 space-y-6 bg-slate-50 min-h-screen">{/* Header */}
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl p-4 border-2 border-slate-200 shadow-sm text-center">
          <div className="text-3xl font-bold text-orange-600">{stats.avgGenerationTime}</div>
      ...
      <div className="bg-white rounded-xl p-4 border-2 border-slate-200 shadow-sm">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 rounded-lg border-2 border-slate-300 focus:outline-none focus:ring-2 focus:ring-green-500 text-slate-900 placeholder-slate-500"
