...
These By-Laws shall apply to all employees of Koyili Hospital including permanent, probationary, contractual, temporary, part-time, and casual employees, as well as consultants, trainees, and interns, except where specifically stated otherwise. The By-Laws are binding on all employees from the date of their appointment or the effective date of these By-Laws, whichever is later.

PURPOSE AND OBJECTIVES:
The primary objectives of these By-Laws are to: (a) establish clear terms and conditions of employment; (b) define rights, responsibilities, and obligations of employees and management; (c) promote a culture of excellence, integrity, and professionalism; (d) ensure fair and equitable treatment of all employees; (e) provide mechanisms for performance management, career development, and skill enhancement; (f) establish transparent procedures for discipline, grievance redressal, and dispute resolution; (g) ensure compliance with all applicable laws and regulations; (h) foster employee engagement, satisfaction, and retention; and (i) support the Hospital's mission of delivering world-class healthcare services.

GUIDING PRINCIPLES:
These By-Laws are founded on the following guiding principles: Fairness and Equity - treating all employees with dignity and without discrimination; Transparency - maintaining open, honest, and clear communication; Meritocracy - recognizing and rewarding performance, competence, and contribution; Legal Compliance - adhering strictly to all applicable laws and regulations; Employee Welfare - promoting the physical, mental, and financial well-being of employees; Patient-Centricity - ensuring all HR policies support excellent patient care; Continuous Improvement - regularly reviewing and updating policies to reflect best practices; and Mutual Respect - fostering a culture of respect between management and employees.`
  },
  section1: {
    id: 'section1',
    number: 'SECTION I',
    ...
    subsections: [
      {
        number: '1.1',
        title: 'Definitions',
        content: 'For the purposes of these By-Laws, unless the context otherwise requires, the following terms shall have the meanings ascribed to them below. These definitions are provided to ensure clarity, consistency, and uniform interpretation throughout the document:',
        points: [
          '"Hospital" or "Koyili Hospital" means Koyili Hospital, a multi-specialty healthcare institution located at Pallikkunnu, Talap, Kannur, Kerala, and includes all its branches, divisions, departments, units, facilities, and associated entities under its management and control.',
          '"Employee" means any person employed by the Hospital under a contract of service, whether express or implied, oral or written, and includes permanent employees, probationary employees, contractual employees, temporary employees, part-time employees, trainees, interns, and casual workers, unless specifically excluded.',
          '"Management" means the Board of Directors, Medical Director, Chief Executive Officer, Administrator, Chief Operating Officer, and other designated senior management personnel authorized to make decisions on behalf of the Hospital in matters of employment and administration.',
          '"Board of Directors" or "Board" means the governing body of Koyili Hospital vested with ultimate authority over all matters of policy, strategy, and governance.',
          '"Department" means any organizational unit, division, section, or functional area within the Hospital structure, including clinical departments (medicine, surgery, pediatrics, obstetrics, etc.), support services (nursing, pharmacy, laboratory, radiology), and administrative departments (HR, finance, IT, maintenance).',
          '"Competent Authority" means the designated officer, manager, or official authorized to make specific decisions, grant approvals, or take actions under these By-Laws. The level of competent authority varies by nature of decision and is specified in relevant policy sections.',
          '"Immediate Supervisor" or "Reporting Manager" means the person to whom an employee directly reports and who is responsible for day-to-day supervision, guidance, performance evaluation, and immediate decision-making related to the employee.',
          '"Department Head" or "Head of Department (HOD)" means the senior-most professional in charge of a clinical or administrative department, responsible for departmental operations, staffing, quality, and performance.',
          '"Human Resources Department" or "HR" means the department responsible for all aspects of human resource management including recruitment, onboarding, payroll, benefits administration, employee relations, training, performance management, and compliance.',
          '"Working Day" or "Business Day" means any day from Monday to Saturday on which the Hospital is open for business operations, excluding Sundays and public holidays as declared by the Hospital or under applicable laws. For shift workers, working days include all rostered duty days.',
          '"Calendar Day" means any day of the year including weekends and holidays, used for calculating notice periods and certain leave entitlements.',
          '"Public Holiday" or "National Holiday" means holidays declared under the Negotiable Instruments Act or by the Government of Kerala or Government of India, and such additional holidays as the Hospital may declare from time to time.',
          '"Continuous Service" or "Length of Service" means uninterrupted service with the Hospital from the date of joining, including all authorized leaves, and excludes periods of unauthorized absence, suspension, or breaks in service.',
          '"Basic Salary" or "Basic Pay" means the fixed monthly remuneration payable to an employee excluding all allowances, incentives, bonuses, overtime, and other variable components. Basic salary forms the basis for calculation of various allowances and statutory contributions.',
          '"Gross Salary" means the total monthly remuneration including basic salary, allowances (HRA, DA, transport, special allowances), and other fixed components before any deductions.',
          '"Net Salary" or "Take-Home Salary" means the amount payable to an employee after all statutory and authorized deductions (PF, ESI, TDS, loans, advances) from gross salary.',
          '"Cost to Company (CTC)" means the total annual cost incurred by the Hospital on an employee, including salary, allowances, statutory contributions (employer\'s share of PF, ESI, gratuity), benefits, insurance, and perquisites.',
          '"Probation" or "Probationary Period" means the initial assessment period, typically six months from date of joining, during which a new employee\'s suitability, performance, and conduct are evaluated before confirmation as a permanent employee.',
          '"Confirmation" means the formal acknowledgment in writing that an employee has successfully completed probation and is appointed as a permanent employee entitled to all applicable benefits and protections.',
          '"Permanent Employee" means an employee who has been confirmed in writing after successful completion of probation and continues in the employment of the Hospital on a regular, full-time basis.',
          '"Temporary Employee" means an employee engaged for a specific duration or project with a defined end date, and whose employment automatically terminates on completion of the assignment or expiry of the term.',
          '"Contractual Employee" means an employee engaged under a fixed-term contract specifying terms, duration, scope of work, and compensation, which may be renewed based on mutual agreement and organizational needs.',
          '"Part-Time Employee" means an employee working less than the standard full-time hours (typically less than 40 hours per week), with pro-rata compensation and benefits.',
          '"Full-Time Employee" means an employee engaged for the standard working hours as defined by the Hospital (typically 40-48 hours per week).',
          '"Consultant" means an external expert or professional engaged on a retainer or assignment basis to provide specialized services, advice, or expertise, working under a consulting agreement rather than an employment contract.',
          '"Trainee" or "Intern" means a medical graduate, nursing student, paramedical student, or management trainee undergoing structured training at the Hospital for skill development and practical experience.',
          '"Resignation" means the voluntary termination of employment initiated by an employee by giving written notice to the Hospital as per the terms of employment.',
          '"Termination" means the cessation of employment initiated by the Hospital due to disciplinary reasons, poor performance, redundancy, or other lawful grounds as specified in these By-Laws.',
          '"Dismissal" or "Summary Termination" means immediate termination of employment without notice or pay in lieu of notice, imposed as a penalty for serious misconduct or gross negligence.',
          '"Retirement" means cessation of employment upon an employee reaching the retirement age specified by the Hospital (typically 60 years) or opting for voluntary early retirement as per policy.',
          '"Retrenchment" means termination of employment due to genuine redundancy, closure of department, economic reasons, or organizational restructuring, with statutory compensation as applicable.',
          '"Lay-off" means temporary cessation of work and wages due to circumstances beyond the Hospital\'s control, such as natural disasters, power shortages, or material unavailability.',
          '"Suspension" means temporary removal of an employee from active duty, with or without pay, pending investigation of alleged misconduct or as an interim disciplinary measure.',
          '"Misconduct" means any act of omission or commission by an employee that violates these By-Laws, Hospital policies, professional ethics, or legal requirements, warranting disciplinary action.',
          '"Gross Misconduct" means serious misconduct such as theft, fraud, violence, sexual harassment, patient abuse, or gross negligence that warrants summary dismissal.',
          '"Disciplinary Action" means any penalty or corrective measure imposed on an employee for violation of rules, policies, or standards, ranging from warning to termination.',
          '"Grievance" means any dissatisfaction or complaint by an employee concerning employment terms, working conditions, treatment by supervisors or colleagues, or violation of rights.',
          '"Sexual Harassment" means any unwelcome sexually determined behavior including physical contact, sexual advances, demands for sexual favors, sexually colored remarks, or showing pornography, as defined under the Sexual Harassment of Women at Workplace (Prevention, Prohibition and Redressal) Act, 2013.',
          '"Whistleblower" means an employee who reports, in good faith, any suspected violation of law, fraud, corruption, safety hazards, or unethical practices within the Hospital.',
          '"Performance Appraisal" or "Performance Review" means the periodic formal assessment of an employee\'s work performance, achievements, competencies, and areas for improvement.',
          '"Increment" means the annual increase in basic salary based on performance, tenure, and Hospital policy, typically granted on a specified date each year.',
          '"Promotion" means advancement to a higher position or grade with increased responsibilities, authority, and compensation, based on merit, performance, and organizational requirements.',
          '"Transfer" means the movement of an employee from one department, location, or role to another within the Hospital, either temporarily or permanently.',
          '"Deputation" means temporary assignment of an employee to work for another organization, government agency, or Hospital unit, while continuing on the payroll of Koyili Hospital.',
          '"Leave" means authorized absence from duty with or without pay, sanctioned by the competent authority as per leave rules.',
          '"Unauthorized Absence" means absence from duty without prior approval or intimation, or absence on grounds not accepted as valid by the competent authority.',
          '"Notice Period" means the advance notice required to be given by either party (employee or Hospital) before termination of employment, as specified in the appointment letter or these By-Laws.',
          '"Pay in Lieu of Notice" means compensation equivalent to salary for the notice period, paid to an employee whose services are terminated without requiring them to serve the notice period.',
          '"Gratuity" means the lump-sum payment made to an employee on separation (retirement, resignation, death, disability) after completing five years of continuous service, calculated as per the Payment of Gratuity Act, 1972.',
          '"Provident Fund (PF)" means the retirement benefit scheme under the Employees\' Provident Funds and Miscellaneous Provisions Act, 1952, with mandatory contributions from both employer and employee.',
          '"Employee State Insurance (ESI)" means the social security and health insurance scheme under the ESI Act, 1948, applicable to employees below specified salary thresholds.',
          '"Confidential Information" means any proprietary, sensitive, or non-public information related to the Hospital\'s operations, patients, finances, strategies, technology, or employees, which is not in the public domain.',
          '"Conflict of Interest" means any situation where an employee\'s personal interests, relationships, or external activities interfere or appear to interfere with their ability to act in the best interests of the Hospital.',
          '"Overtime" means work performed beyond standard working hours, sanctioned by the supervisor, and compensated as per applicable rules.',
          '"Shift Allowance" means additional compensation paid to employees working in night shifts or rotating shifts to compensate for inconvenience.',
          '"Medical Benefits" means healthcare coverage, insurance, or reimbursement provided to employees and their dependents as per Hospital policy.',
          '"Annual Training Plan" means the yearly training and development roadmap identifying training needs, programs, and budgets for employee skill enhancement.',
          '"Code of Conduct" means the set of rules and behavioral standards that all employees must adhere to in their professional capacity.',
          '"Background Verification" means the process of verifying the credentials, employment history, educational qualifications, criminal record, and references of prospective employees before or after appointment.',
          '"Exit Formalities" or "Full and Final Settlement" means the administrative process completed by a separating employee, including handover of responsibilities, return of assets, clearance from all departments, and settlement of dues.',
          '"Garnishee Order" or "Attachment Order" means a legal order directing the Hospital to deduct and remit a portion of an employee\'s salary to a court or creditor.',
          '"Biometric Attendance" means the electronic attendance recording system using fingerprint, facial recognition, or iris scan for marking employee attendance.',
          '"Work from Home (WFH)" or "Remote Work" means an arrangement where an employee performs duties from a location outside the Hospital premises, with prior approval and subject to policy guidelines.',
          '"Onboarding" means the process of integrating a new employee into the Hospital, including orientation, documentation, training, and introduction to the work environment.',
          '"Offboarding" means the process of managing an employee\'s departure, including knowledge transfer, exit interviews, asset recovery, and documentation.',
          '"Personnel File" means the official record maintained by HR containing all documents related to an employee\'s employment including application, appointment letter, performance reviews, training records, and correspondence.'
        ]
      },
      {
        number: '1.2',
