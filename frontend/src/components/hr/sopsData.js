    ...
    subsections: [
      {
        number: '1',
        title: 'OBJECTIVE',
        content: 'To define formal process for employees to appeal disciplinary decisions, grievance outcomes, or administrative actions ensuring right to reconsideration, fresh perspective, error correction, and fairness through structured appellate mechanism maintaining organizational justice.'
      },
      {
        number: '2',
        title: 'SCOPE',
        content: 'Covers appeals against disciplinary actions, grievance resolution decisions, performance ratings, terminations, transfers, and other adverse employment decisions. Applicable to all employees with clearly defined appellate authorities and timelines.'
      },
      {
        number: '3',
        title: 'RIGHT TO APPEAL',
        content: `Employees can appeal:
• Disciplinary actions (warnings, suspension, demotion, termination)
• Grievance redressal outcomes (if dissatisfied)
• Performance appraisal ratings
• Denial of promotion or increment
• Forced transfer or demotion
• Denial of benefits or entitlements

Grounds for Appeal:
• Procedural error or violation of natural justice
• New evidence not considered earlier
• Decision disproportionate to offense
• Factual errors or misinterpretation
• Bias or conflict of interest in original decision`
      },
      {
        number: '4',
        title: 'APPEAL FILING PROCESS',
        content: `(i) Timeline:
• Appeal filed within 7-15 working days of decision (varies by case type)
• Late appeals: May be condoned if valid reason (illness, absence)

(ii) Format:
• Written appeal letter or form (Annexure M.4.1)
• Address to appropriate appellate authority
• Clearly state decision being appealed and grounds
• Attach supporting documents or new evidence
• Signed by employee

(iii) Submission:
• HR department (maintains appeal register)
• Email or physical submission with acknowledgment`
      },
      {
        number: '5',
        title: 'APPELLATE AUTHORITIES',
        content: `Level-wise appellate structure:

Original Decision By → Appeal To:
• Supervisor → Department Head
• Department Head → HR Head / CHRO
• HR Department → Senior Management
• CHRO → CEO
• CEO → Board / Governing Body (final)

Principle: Appeal to next higher authority not involved in original decision`
      },
      {
        number: '6',
        title: 'APPEAL REVIEW PROCESS',
        content: `(i) Acknowledgment (within 3 days)
(ii) Record Review:
    • Appellate authority reviews original case file
    • Appeal grounds and new evidence
    • Policies and procedures followed
(iii) Fresh Perspective:
    • Independent assessment
    • Not bound by original decision but gives weight
(iv) May conduct:
    • Additional inquiries if needed
    • Interviews with appellant or others
    • Seek clarifications from original deciding authority
(v) Decision:
    • Uphold original decision
    • Modify decision (reduced penalty, changed outcome)
    • Overturn decision (appeal allowed)
    • Remand for fresh inquiry (if serious procedural flaw)`
      },
      {
        number: '7',
        title: 'APPELLATE DECISION TIMELINE',
        content: `• Decision within 15-30 working days of appeal
• Complex cases: Up to 45 days
• Delay: Employee informed with reasons
• Pending appeal: Original decision implementation may be stayed (case-by-case)`
      },
      {
        number: '8',
        title: 'OUTCOME COMMUNICATION',
        content: `• Decision communicated in writing
• Reasons for upholding, modifying, or overturning
• Revised action (if decision modified)
• Finality: If no further appeal, decision is final
• Implementation of revised decision (if appeal allowed)`
      },
      {
        number: '9',
        title: 'FINALITY OF DECISIONS',
        content: `• Appeal to CEO/Board is final (no further internal appeal)
• Employee can still approach external forums:
    - Labor Commissioner
    ...
    - Ombudsman (if available)`
      ...
      {
        number: '10',
        title: 'SPECIAL APPEAL PROVISIONS',
        content: `Performance Appraisal Appeal:
• Filed within 15 days of appraisal discussion
• Appeal to next level manager or HR
• Review of ratings and evidence
• Rating may be revised if justified

Termination Appeal:
• Urgent review given priority
• Detailed scrutiny of inquiry and evidence
• High bar for overturning (must show serious flaw)
• If reinstated: Back wages and continuity of service`
      },
      {
        number: '11',
        title: 'PROHIBITION OF REPEATED APPEALS',
        content: `• Only one appeal per decision (to next level)
• Cannot appeal same issue repeatedly to different authorities
• Frivolous appeals discouraged
• However, new grounds or evidence: May file fresh representation`
      },
      {
        number: '12',
        title: 'PROTECTION DURING APPEAL',
        content: `• No retaliation for filing appeal
• Pending appeal: Employee continues in role (unless suspended)
• If termination appealed: May request stay of termination (authority decides)
• Appeal filing does not prevent employer from implementing decision (unless stay granted)`
      },
      {
        number: '13',
        title: 'DOCUMENTATION',
        content: `Maintained:
• Appeal letter and grounds
• Appellate authority review notes
• Additional evidence or inquiries
• Appellate decision letter
• Implementation status
• Retained with original case file`
      },
      {
        number: '14',
        title: 'REFERENCE DOCUMENTS',
        content: 'Grievance & Appeals Policy, Disciplinary Policy, Performance Management Policy, Annexure M.4.1: Appeal Form, Annexure M.4.2: Appellate Decision Template'
      }
    ]
  },
    ...
    subsections: [
      {
        number: '1',
        title: 'OBJECTIVE',
        content: 'To establish comprehensive protocol for prevention, prohibition, redressal of sexual harassment at workplace in compliance with Prevention of Sexual Harassment (POSH) Act, 2013 through Internal Complaints Committee (ICC), ensuring safe, respectful workplace free from harassment, protecting complainant rights, and maintaining zero-tolerance culture.'
      },
      {
        number: '2',
        title: 'SCOPE',
        content: 'Covers all employees, contractors, consultants, patients, visitors at hospital premises or work-related settings. Defines sexual harassment, complaint mechanism, ICC functioning, investigation, remedies, and preventive measures as mandated by law.'
      },
      {
        number: '3',
        title: 'LEGAL FRAMEWORK',
        content: `• Sexual Harassment of Women at Workplace (Prevention, Prohibition and Redressal) Act, 2013
• Mandatory for all establishments with 10+ employees
• Criminal offense not to comply
• Regular training and awareness mandatory`
      },
      {
        number: '4',
        title: 'DEFINITION OF SEXUAL HARASSMENT',
        content: `Unwelcome sexually determined behavior, directly or by implication:
...
Circumstances (any one sufficient):
...
Key: "Unwelcome" - recipient did not consent or encourage`
      },
      {
        number: '5',
        ...
        subsections: [
          {
            number: '5.1',
            title: 'Composition (As per POSH Act)',
            content: `Minimum 4 members:
(i) Presiding Officer:
    • Senior woman employee
    • Commitment to women rights

(ii) Internal Members (at least 2):
    • Employees committed to women cause or with legal/social work background
    • At least 50% must be women

(iii) External Member (mandatory):
    • NGO or association working on women rights
    • Familiar with sexual harassment issues
    • Provides independence and expertise

Quorum: 3 members (including Presiding Officer and External Member mandatory)
Tenure: 3 years maximum`
          },
          {
            number: '5.2',
            title: 'ICC Contact Details',
            content: `• Names, contact numbers, email IDs displayed prominently at workplace
• Dedicated email: icc@koyilihospital.com
• Confidential helpline (if available)
• Information on notice boards, intranet, employee handbook`
          }
        ]
      },
      {
        ...
        content: `Who Can Complain:
• Aggrieved woman employee
• If unable (due to incapacity): Relative, friend, coworker, or organization can file on her behalf with written consent

Timeline:
• Within 3 months of incident (or last incident if continuing harassment)
• Extension: ICC may extend by 3 months if satisfied with reasons for delay

How to File:
• Written complaint to ICC
• Email, letter, or in-person submission
• Complaint must contain:
    - Name and contact of complainant
    - Details of respondent (alleged harasser)
    - Description of incident(s) with dates, times, places
    - Names of witnesses (if any)
    - Supporting documents (emails, messages, CCTV, etc.)

Confidentiality:
• Complaint treated with utmost confidentiality
• Identity not disclosed except to respondent (for defense)`
      },
      {
        number: '7',
        title: 'ICC INQUIRY PROCESS',
        subsections: [
          {
            number: '7.1',
            title: 'Preliminary Steps',
            content: `(i) Complaint received and registered within 7 days
(ii) Copy of complaint provided to respondent
(iii) Respondent submits written response within 10 working days
(iv) ICC decides:
    • Proceed with inquiry OR
    • Refer to conciliation (if complainant agrees and appropriate)`
          },
          {
            number: '7.2',
            title: 'Conciliation (Optional)',
            content: `• If parties agree, ICC may facilitate settlement
• No monetary settlement (prohibited by law)
• Settlement recorded, signed by both parties
• Copy to complainant, respondent, and employer
• No further inquiry if settled
• If conciliation fails: Proceed with inquiry`
          },
          {
            number: '7.3',
            title: 'Formal Inquiry',
            content: `Conducted if:
• Conciliation not opted or failed
• Serious allegations

Process:
(i) Inquiry to be completed within 90 days
(ii) Principles of natural justice followed:
    • Complainant presents case, evidence, witnesses
    • Respondent defends, presents evidence, witnesses
    • Cross-examination allowed (controlled)
    • Both parties can be accompanied by colleague (not lawyer)
(iii) Hearings conducted in private
(iv) Evidence: Documents, emails, CCTV, witness statements, expert testimony
(v) ICC members maintain confidentiality
(vi) Interim relief provided if needed (see below)`
          },
          {
            number: '7.4',
            title: 'Interim Relief (During Inquiry)',
            content: `If requested by complainant and deemed necessary, ICC recommends:
• Transfer of complainant or respondent (to avoid contact)
• Grant leave to complainant (if requested)
• Restrain respondent from specific actions
• Any other measure to ensure safety and comfort

Employer must implement interim relief within timeframe specified by ICC`
          }
        ]
      },
      {
        number: '8',
        title: 'ICC FINDINGS & REPORT',
        content: `Within 10 days of completing inquiry:
(i) ICC prepares report with findings:
    • Sexual harassment proved OR not proved
    • Reasoning and evidence analysis
(ii) Recommendations:
    • If proved: Action against respondent
    • If false/malicious complaint: Action against complainant
(iii) Report submitted to employer
(iv) Copies to complainant and respondent`
      },
      {
        number: '9',
        title: 'EMPLOYER ACTION',
        content: `If Sexual Harassment Proved:
Employer must take action within 60 days:
• Deduction from salary (compensation to victim)
...
• Paid by respondent (deducted from salary)

If Complaint False or Malicious:
• Action against complainant (as per ICC recommendation)
• Only if proven complaint was knowingly false with malicious intent (high bar)
• Complainant has right of appeal`
      },
      {
        number: '10',
        title: 'APPEAL',
        content: `• Either party (complainant or respondent) can appeal ICC decision
• Appeal to Appellate Authority (as per law) or internal appeal to senior management
• Timeline: Within specified period (typically 90 days)
• Appellate authority reviews case independently`
      },
      {
        number: '11',
        title: 'CONFIDENTIALITY & PROTECTION',
        content: `• Entire process confidential
• Names, identities, testimonies not disclosed publicly
• Breach of confidentiality: Disciplinary action (can include termination)
• Publishing or sharing details: Punishable by law

Protection Against Retaliation:
• No adverse action against complainant for filing complaint
• No victimization during or after inquiry
• Retaliation itself is misconduct`
      },
      {
        number: '12',
        title: 'PREVENTIVE MEASURES',
        content: `(i) Awareness & Training:
• Annual POSH training for all employees (mandatory)
• Orientation for new joiners
• Manager training on prevention and response
• Regular communication campaigns

(ii) Policy Display:
• POSH policy and ICC details prominently displayed
• Employee handbook includes policy
• Intranet and notice boards

(iii) Safe Environment:
• CCTV, lighting, security
• Reporting mechanisms clearly communicated
• Zero-tolerance message from leadership`
      },
      {
        number: '13',
        title: 'ANNUAL REPORT',
        content: `ICC submits annual report to employer (and District Officer as per law):
...
Mandatory legal compliance`
      },
      {
        number: '14',
        title: 'PENALTIES FOR NON-COMPLIANCE',
        content: `Employer liable if:
• No ICC constituted
• ICC recommendations not implemented
• False information in annual report

Penalty: Up to ₹50,000 fine
Repeated violations: Cancellation of business license`
      },
      {
        number: '15',
        title: 'REFERENCE DOCUMENTS',
        content: 'Sexual Harassment of Women at Workplace (Prevention, Prohibition and Redressal) Act 2013, POSH Rules 2013, Hospital POSH Policy, Annexure M.5.1: POSH Complaint Form, Annexure M.5.2: ICC Inquiry Procedure, Annexure M.5.3: Annual POSH Report Template'
      }
    ]
  },
