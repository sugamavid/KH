...
const ProfessionalK2Form = () => {
  const [formData, setFormData] = useState({
    effectiveDate: '', empName: '', empId: '', dept: '', designation: '', date: '',
    acknowledgment: false, signature: '', signDate: '', place: '',
    hrName: '', hrDate: ''
  });
  ...
  const handleSave = () => {
    ...
    a.href = url;
    a.download = 'Annexure_K2_IT_Security_Acknowledgment.json';
    a.click();
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg">
        <div className="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-700 px-8 py-6">
          <div className="grid grid-cols-[200px_1fr_200px] gap-6 items-center">
            ...
            <div className="text-center text-white">
              ...
              <p className="text-xs opacity-75">NABH Accredited • Cybersecurity Awareness</p>
            </div>
            <div className="text-right space-y-1">
              <div className="inline-block bg-white/20 backdrop-blur-sm px-3 py-1 rounded text-xs text-white font-semibold">Annexure K2</div>
        ...
        <div className="bg-blue-50 border-b-2 border-blue-900 px-8 py-4">
          <h2 className="text-xl font-bold text-blue-900 text-center">IT SECURITY AWARENESS ACKNOWLEDGMENT</h2>
        </div>
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="border border-gray-300 rounded-lg overflow-hidden">
            <div className="bg-blue-50 px-4 py-2 border-b border-gray-300">
              <div className="flex items-center gap-2">
                <div className="w-1 h-5 bg-gradient-to-b from-yellow-500 to-blue-700 rounded"></div>
                <h3 className="font-semibold text-blue-900">Acknowledgment</h3>
              </div>
            </div>
            <div className="p-4 space-y-4">
              <label className="flex items-start gap-3">
                <input type="checkbox" name="acknowledgment" checked={formData.acknowledgment} onChange={handleChange} className="mt-1 w-4 h-4" />
                <span className="text-sm text-gray-700">I acknowledge that I have attended the IT Security Awareness training and understand the importance of information security, data protection, and cyber hygiene. I commit to following all IT security policies and guidelines.</span>
              </label>
        ...
        <div className="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-700 px-8 py-4 mt-8">
          <div className="flex justify-between items-center text-white text-xs">
            ...
            <div className="font-semibold">Annexure K2 • IT Security Awareness Acknowledgment</div>
          </div>
        </div>
      </div>
    </div>
...
export default ProfessionalK2Form;