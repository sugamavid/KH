    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-6 py-8 print:py-4">
        <div className="grid grid-cols-[240px_1fr] gap-6 items-center pb-6 border-b-4 border-blue-900 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-black text-blue-900 uppercase tracking-tight">Conflict of Interest Disclosure Form</h1>
            <p className="text-gray-600 font-bold mt-2">HR • SOP G.3 – Conflict of Interest Management • Annexure G3</p>
          </div>
        </div>
