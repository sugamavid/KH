...
const ProfessionalC5Form = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto bg-white shadow-2xl">
      <div className="bg-gradient-to-r from-neutral-700 via-gray-600 to-neutral-600 text-white p-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-6">
            ...
            <div>
              ...
              <p className="text-neutral-200 text-sm mt-1">Medical Administration</p>
              <p className="text-neutral-300 text-xs">Pallikkunnu, Talap, Kannur, Kerala</p>
            </div>
          </div>
          <div className="text-right">
            <div className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg border border-white/20">
              <p className="text-xs text-neutral-200 mb-1">Document Classification</p>
              <p className="text-sm font-bold">CLINICAL CREDENTIALING</p>
            </div>
          </div>
        </div>
      </div>
