...
const ProfessionalB6Form = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto bg-white shadow-2xl">
      <div className="bg-gradient-to-r from-rose-700 via-pink-700 to-red-700 text-white p-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-6">
            ...
            <div>
              ...
              <p className="text-rose-200 text-sm mt-1">Human Resources Department</p>
              <p className="text-rose-300 text-xs">Pallikkunnu, Talap, Kannur, Kerala</p>
            </div>
          </div>
          <div className="text-right">
            <div className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg border border-white/20">
              <p className="text-xs text-rose-200 mb-1">Document Classification</p>
