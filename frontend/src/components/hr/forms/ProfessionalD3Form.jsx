...
const ProfessionalD3Form = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto bg-white shadow-2xl">
      <div className="bg-gradient-to-r from-purple-700 via-violet-600 to-purple-600 text-white p-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-6">
            ...
            <div>
              ...
              <p className="text-purple-200 text-sm mt-1">Finance & HR Department</p>
          ...
          <div className="text-right">
            <div className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg border border-white/20">
              ...
              <p className="text-sm font-bold">STATUTORY REGISTER</p>
            </div>
          </div>
        </div>
      </div>
