...
const ProfessionalB10Form = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto bg-white shadow-2xl">
      <div className="bg-gradient-to-r from-blue-800 via-indigo-800 to-blue-900 text-white p-8">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <div className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg border border-white/20">
              <p className="text-xs text-blue-200 mb-1">Document Type</p>
              <p className="text-sm font-bold">APPOINTMENT LETTER</p>
            </div>
          </div>
        </div>
      </div>
