...
const ProfessionalD4Form = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto bg-white shadow-2xl">
      <div className="bg-gradient-to-r from-teal-700 via-cyan-600 to-teal-600 text-white p-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-6">
            ...
            <div>
              ...
              <p className="text-teal-200 text-sm mt-1">HR / Administration Department</p>
              <p className="text-teal-300 text-xs">Pallikkunnu, Talap, Kannur, Kerala</p>
            </div>
          </div>
          <div className="text-right">
            <div className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg border border-white/20">
              <p className="text-xs text-teal-200 mb-1">Compliance Document</p>
              <p className="text-sm font-bold">DISPLAY BOARD CHECKLIST</p>
            </div>
          </div>
        </div>
      </div>
