...
const ProfessionalA4Form = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto bg-white shadow-2xl">
      {/* Professional Header */}
      <div className="bg-gradient-to-r from-orange-700 via-red-700 to-pink-700 text-white p-8">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <div className="bg-white/10 backdrop-blur-sm px-4 py-2 rounded-lg border border-white/20">
              <p className="text-xs text-orange-200 mb-1">Document Classification</p>
